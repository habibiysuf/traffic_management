...
@Gooey(
    program_name="Managemen Pengaturan Lampu Lalu Lintas",
    ...
    menu=[{'name': 'File', 'items': [{
        ...
        'developer': "Maulana Yusuf, Rahadiyan Yusuf",
        'license': 'ITB' }]
        }]
...
def main():
    ...
    while True:
        ...
        if len(devices) == 1:
            ...
            if devices[0] == "raspberrypi_jos":
                count_a = objCount["car"]
            else:
                count_a = random.randint(1,9)
            if devices[1] == "raspberrypi":
